...
export default function Create({ permissions, existingLevels, accessLevels }) {
  ...
  if (!canCreateRoles) {
    Swal.fire({
      ...
      if (canViewRoles) router.visit(route('backend.roles.index'));
      else router.visit('/');
    });
    return (
      <AuthenticatedLayout>
            ...
            <div className="p-8 space-y-8">
              ...
              <section>
                <h2 className="text-xl font-semibold text-gray-900 mb-4 flex items-center gap-2">
                  <FaShieldAlt className="text-purple-600" /> Basic Information
                </h2>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        placeholder="e.g., content-manager"
                        className={`w-full pl-8 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 font-mono text-sm ${errors.slug ? 'border-red-500' : 'border-gray-300'}`}
                      />
                    </div>
                ...
                <div className="mt-4">
                  ...
                  <div className="flex gap-4 items-center">
                    <input
                      ...
                      min="1"
                      max="100"
                      className={`w-24 px-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 text-center ${errors.level ? 'border-red-500' : 'border-gray-300'}`}
                    />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                  ...
                  {/* <label className="flex items-center justify-between p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition">
                    ...
                    <input type="checkbox" name="is_default" checked={formData.is_default} onChange={handleChange} className="w-5 h-5 text-purple-600 rounded focus:ring-purple-500" />
                  </label> */}
                </div>
              </section>
              ...
              <section>
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-xl font-semibold text-gray-900 flex items-center gap-2">
                    <FaKey className="text-purple-600" /> Permissions
                  </h2>
                ...
                <div className="flex flex-col sm:flex-row gap-3 mb-4">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg flex items-center gap-2 transition ${showSelectedOnly ? 'bg-purple-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
                  >
                              ...
                              <button onClick={() => toggleModule(module.module)} className="flex items-center gap-3 flex-1 text-left">
                                ...
                                <div>
                                  ...
                                  <div className="flex items-center gap-2 mt-0.5">
                                    ...
                                    {someSelected && <span className="text-xs text-purple-600 bg-purple-50 px-2 py-0.5 rounded-full">{selectedCount}/{module.permissions.length} selected</span>}
                                    {!someSelected && !allSelected && selectedCount === 0 && <span className="text-xs text-gray-400">None selected</span>}
                                  </div>
                                </div>
                              </button>
                              <div className="flex items-center gap-2">
                                {!allSelected && <button onClick={() => selectAllModule(module.permissions)} className="text-xs text-purple-600 hover:text-purple-800 px-2 py-1 rounded hover:bg-purple-50">Select All</button>}
              ...
              <section>
                <h2 className="text-xl font-semibold text-gray-900 mb-4 flex items-center gap-2">
                  <FaLock className="text-purple-600" /> Module Access Levels
                </h2>
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            ...
                            <div className="flex items-center gap-2">
                              <select
                                ...
                                className={`px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-purple-500 ${getAccessLevelColor(currentLevel)}`}
                              >
                                {accessLevels.map(l => (
                ...
                <div className="mt-4 bg-purple-50 rounded-lg p-4 flex items-start gap-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-yellow-700 mt-1">
                      Once created, this role can be assigned to users. You can edit later, but changes affect all users.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <div className="flex justify-between items-center pt-4 border-t border-gray-200">
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-linear-to-r from-purple-600 to-indigo-600 text-white rounded-lg hover:from-purple-700 hover:to-indigo-700 transition shadow-md hover:shadow-lg flex items-center gap-2 disabled:opacity-50"
                >
